...
bash "$SCRIPT_DIR/tests/wiki-context-json-render-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-context-scaffold-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/scaffold-practice-skill-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-card-roles-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/bootstrap-wiki-template-import.sh"
...
bash "$SCRIPT_DIR/tests/lanhu-url-root-selection-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/lanhu-confirmation-gate-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/lanhu-contradiction-detection-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/lanhu-effective-prd-sanitization-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/lanhu-scoped-evidence-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/post-merge-update-wiki-hook-smoke.sh" "$TARGET_DIR"
...
bash "$SCRIPT_DIR/tests/test-wiki-section.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-section-index-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-summary-backfill-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-section-graph-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-graph-neighbors-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-depends-on-closure-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-materialize-task-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/wiki-page-type-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/export-wiki-skills-smoke.sh"
bash "$SCRIPT_DIR/tests/wiki-import-skill-path-smoke.sh" "$TARGET_DIR" "$REPO_ROOT"
...
bash "$SCRIPT_DIR/tests/version-gate-smoke.sh" "$TARGET_DIR"
