...
bash "$SCRIPT_DIR/tests/wiki-settings-smoke.sh" "$TARGET_DIR"
...
bash "$SCRIPT_DIR/tests/multica-runtime-build-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/multica-runtime-install-dry-run-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/multica-bootstrap-dry-run-smoke.sh" "$TARGET_DIR"
bash "$SCRIPT_DIR/tests/multica-live-acceptance-dry-run-smoke.sh" "$TARGET_DIR"
