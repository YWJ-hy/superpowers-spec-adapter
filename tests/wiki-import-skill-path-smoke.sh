...
TARGET_FILE="$PROJECT_ROOT/.superpowers/wiki/imported-skill-path-smoke/path-smoke.md"
...
if [[ ! -f "$PROJECT_ROOT/.superpowers/wiki/imported-skill-path-smoke/index.md" ]]; then
...
SHARED_TARGET_FILE="$PROJECT_ROOT/.shared-superpowers/wiki/imported-skill-path-smoke/shared-path-smoke.md"
...
if [[ ! -f "$PROJECT_ROOT/.shared-superpowers/wiki/imported-skill-path-smoke/index.md" ]]; then
  printf 'Expected shared imported subdirectory index to be refreshed\n' >&2
  exit 1
fi
if [[ -e "$PROJECT_ROOT/.superpowers/wiki/imported-skill-path-smoke/shared-path-smoke.md" ]]; then
