...
description: Use this agent to turn Lanhu MCP content into a sanitized frontend html Lanhu original-requirement evidence package under `.lanhu/`, split by source evidence boundary with an index entrypoint. It does not plan implementation or update wiki.
model: inherit
---
